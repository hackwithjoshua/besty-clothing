...
const emptyForm = {
  ...
  sizes: [] as string[],
  colors: '',
  images: [''] as string[],   // array of URL inputs
  inStock: true,
  featured: false,
};
      ...
      <div className="max-w-6xl mx-auto px-5 lg:px-8 py-8 lg:py-10">
        ...
        <div className="flex items-start justify-between mb-6 gap-4">
          <div>
            ...
            <h1 className="font-heading text-3xl font-light text-ink">Product Management</h1>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-heading text-xl font-light text-ink">Products ({products.length})</h2>
          </div>
